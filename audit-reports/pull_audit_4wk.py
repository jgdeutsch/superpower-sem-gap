#!/usr/bin/env python3
"""Pull comprehensive Google Ads performance data for 4-week audit (Jan 26 - Feb 22, 2026)."""
...
# Fixed date range: 4 weeks (Jan 26 - Feb 22, 2026)
DATE_FROM = "2026-01-26"
DATE_TO = "2026-02-22"

print(f"Date range: {DATE_FROM} to {DATE_TO} (4 weeks)")
...
if rows1 is not None:
    ...
    write_csv("/tmp/audit_search_adgroups_daily_4wk.csv",
...
if rows2 is not None:
    ...
    write_csv("/tmp/audit_search_conversions_by_action_4wk.csv",
...
if rows3 is not None:
    ...
    write_csv("/tmp/audit_pmax_assetgroups_daily_4wk.csv",
...
if rows4 is not None:
    ...
    write_csv("/tmp/audit_pmax_conversions_by_action_4wk.csv",
...
if rows5 is not None:
    ...
    write_csv("/tmp/audit_search_terms_4wk.csv",
...
if rows6 is not None:
    ...
    write_csv("/tmp/audit_landing_pages_4wk.csv",
              ["campaign", "landing_page_url", "date", "cost", "clicks", "impressions", "conversions"],
              data)

print()
print("=" * 60)
print("DONE. All CSV files written to /tmp/audit_*_4wk.csv")
print("=" * 60)
