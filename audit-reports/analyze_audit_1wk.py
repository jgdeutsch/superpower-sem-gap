#!/usr/bin/env python3
"""
Comprehensive Google Ads Audit Analysis - 1 Week
Data: Feb 16 - Feb 22, 2026
...
# ─────────────────────────────────────────────────────────────────────
output_file = '/tmp/audit_report_1wk.txt'
...
print("\n" + "=" * 80)
print("  LOADING DATA... (BRAND EXCLUDED VERSION - 1 WEEK: Feb 16-22, 2026)")
print("=" * 80)

search_daily = pd.read_csv('/tmp/audit_search_adgroups_daily_1wk.csv')
search_conv = pd.read_csv('/tmp/audit_search_conversions_by_action_1wk.csv')
pmax_daily = pd.read_csv('/tmp/audit_pmax_assetgroups_daily_1wk.csv')
pmax_conv = pd.read_csv('/tmp/audit_pmax_conversions_by_action_1wk.csv')
search_terms = pd.read_csv('/tmp/audit_search_terms_1wk.csv')
landing_pages = pd.read_csv('/tmp/audit_landing_pages_1wk.csv')
...
print("║  Period: Feb 16-22, 2026 (1 Week)                                         ║")
print("╚" + "═" * 78 + "╝")
...
print("\n")
print("╔" + "═" * 78 + "╗")
print("║  SECTION 2: CLASSIFICATION SUMMARY (Brand Excluded, 1 Week)" + " " * 17 + "║")
print("╚" + "═" * 78 + "╝")
...
print("\n")
print("╔" + "═" * 78 + "╗")
print("║  SECTION 3: CAMPAIGN-LEVEL ROLLUP (Brand Excluded, 1 Week)" + " " * 18 + "║")
print("╚" + "═" * 78 + "╝")
...
print("\n")
print("╔" + "═" * 78 + "╗")
print("║  SECTION 4: STRATEGY-LEVEL ROLLUP (Brand Excluded, 1 Week)" + " " * 18 + "║")
print("╚" + "═" * 78 + "╝")
...
print("\n")
print("╔" + "═" * 78 + "╗")
print("║  SECTION 5: THEME PERFORMANCE (Brand Excluded, 1 Week)" + " " * 22 + "║")
print("╚" + "═" * 78 + "╝")
...
print("\n")
print("╔" + "═" * 78 + "╗")
print("║  SECTION 7: LANDING PAGE PERFORMANCE ($50+ Spend, Brand Excluded, 1 Wk)   ║")
print("╚" + "═" * 78 + "╝")
...
# Lower threshold to $50 for 1-week window (was $200 for 4 weeks)
lp_filtered = lp_agg[lp_agg['spend'] >= 50].sort_values('conv_rate', ascending=False)
...
print("\n")
print("╔" + "═" * 78 + "╗")
print("║  SECTION 8: CPR vs CPS DISTRIBUTION ANALYSIS (Brand Excluded, 1 Week)     ║")
print("╚" + "═" * 78 + "╝")
...
if len(has_both) >= 3:
    ...
    print("  Not enough data for sweet spot analysis.")
...
print("\n")
print("╔" + "═" * 78 + "╗")
print("║  SECTION 9: PATTERN ANALYSIS - GOOD vs BAD (Brand Excluded, 1 Week)       ║")
print("╚" + "═" * 78 + "╝")
...
print("\n")
print("╔" + "═" * 78 + "╗")
print("║  SECTION 10: PMAX DEEP DIVE (Brand Excluded, 1 Week)" + " " * 24 + "║")
print("╚" + "═" * 78 + "╝")
...
print("\n")
print("╔" + "═" * 78 + "╗")
print("║  SECTION 12: EFFICIENCY FRONTIER - Top 15 by Reg>Sub% (min 2 regs, 1 Wk) ║")
print("╚" + "═" * 78 + "╝")

# Lower threshold to 2 regs for 1-week window (was 5 for 4 weeks)
eff_groups = master[master['regs'] >= 2].sort_values('reg_sub_pct', ascending=False).head(15)
...
print("\n")
print("╔" + "═" * 78 + "╗")
print("║  EXECUTIVE SUMMARY (BRAND EXCLUDED, 1 WEEK: Feb 16-22, 2026)" + " " * 16 + "║")
print("╠" + "═" * 78 + "╣")
...
ls_spend = master[master['classification'] == 'LOW-SPEND']['spend'].sum()
...
print_summary_line(f"Period: Feb 16 - Feb 22, 2026 (1 week) -- BRAND CAMPAIGNS EXCLUDED")
...
print_summary_line(f"GOOD  (<$350 CPS): ${good_spend:>8,.0f} spend | {good_subs:>6,.1f} subs | CPS ${safe_div(good_spend, good_subs):>7,.0f}" if good_subs > 0 else f"GOOD  (<$350 CPS): ${good_spend:>8,.0f} spend | {good_subs:>6,.1f} subs | CPS       -")
print_summary_line(f"MIDDLE ($350-500): ${mid_spend:>8,.0f} spend | {mid_subs:>6,.1f} subs | CPS ${safe_div(mid_spend, mid_subs):>7,.0f}" if mid_subs > 0 else f"MIDDLE ($350-500): ${mid_spend:>8,.0f} spend | {mid_subs:>6,.1f} subs | CPS       -")
if bad_subs > 0:
...
print_summary_line(f"LOW-SPEND:         ${ls_spend:>8,.0f} spend")

print("╚" + "═" * 78 + "╝")

print(f"\n  Analysis complete. All 12 sections generated.")
print(f"  Total groups analyzed: {len(master)} (brand excluded)")
print(f"  Script: /tmp/analyze_audit_1wk.py")
print(f"  Report: /tmp/audit_report_1wk.txt")
print()
