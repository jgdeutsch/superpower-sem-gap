"""LP type split by Search vs PMAX with CPR/CPS - 4wk."""
import yaml
...
date_range = "segments.date BETWEEN '2026-01-26' AND '2026-02-22'"
...
for channel in ['Search', 'PMAX']:
    ...
    print(f"\n{'='*120}")
    print(f"  {channel} — 4WK (Jan 26 - Feb 22) | Brand Excluded")
